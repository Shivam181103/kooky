    ...
    return (
        <>
            ...
            <div id='feature'  className="product-features row m-0  ">
                ...
                <div  className="col col-lg-6 col-md-6 col-sm-12 col-xm-12 features-img d-flex ">
                ...
                <div className="slide-container">
                    <Slider {...settings1}>
                        ...
                        <div className='slider-img-wrapper'>
                            <div className='slider-img-container'><img className='slider-img-second'  src={img2} alt="" />
                        </div></div>
                        <div>
